    ...
    def _load_tech_signatures(self) -> List[TechSignature]:
        ...
        return [
            ...
            TechSignature(
                ...
                confidence_indicators=[r'generator.*wordpress', r'wp\-content', r'wp\-includes', r'rest_route'],
                version_patterns=[r'WordPress (\d+\.\d+(?:\.\d+)?)']
            ),
            TechSignature(
                name="Drupal",
                category="cms",
                patterns=[r'/sites/default/', r'/modules/', r'/themes/', r'drupal', r'Drupal\.settings'],
                confidence_indicators=[r'generator.*drupal', r'sites/default', r'Drupal\.settings'],
                version_patterns=[r'Drupal (\d+\.\d+(?:\.\d+)?)']
            ),
            TechSignature(
                name="Joomla",
                category="cms",
                patterns=[r'/components/', r'/modules/', r'/templates/', r'joomla', r'option=com_'],
                confidence_indicators=[r'generator.*joomla', r'option=com_', r'components/'],
                version_patterns=[r'Joomla! (\d+\.\d+(?:\.\d+)?)']
            ),
            TechSignature(
                name="Shopify",
                category="cms",
                patterns=[r'shopify', r'myshopify\.com', r'cdn\.shopify\.com', r'Shopify\.theme'],
                confidence_indicators=[r'Shopify\.theme', r'shopify\-analytics', r'myshopify\.com']
            ),
            TechSignature(
                name="Magento",
                category="cms", 
                patterns=[r'magento', r'/skin/frontend/', r'/js/mage/', r'Mage\.Cookies'],
                confidence_indicators=[r'Mage\.Cookies', r'skin/frontend', r'js/mage']
            ),
            TechSignature(
                name="WooCommerce",
                category="cms",
                patterns=[r'woocommerce', r'wc\-', r'wp\-content/plugins/woocommerce'],
                confidence_indicators=[r'woocommerce', r'wc\-ajax', r'plugins/woocommerce']
            ),
            # JavaScript Frameworks
            TechSignature(
                name="React",
                category="framework",
                patterns=[r'react', r'_react', r'React\.', r'__REACT_DEVTOOLS_'],
                confidence_indicators=[r'data\-reactroot', r'__REACT_DEVTOOLS_', r'React\.', r'_react']
            ),
            TechSignature(
                name="Vue.js",
                category="framework",
                patterns=[r'vue', r'Vue\.', r'__VUE__', r'v\-'],
                confidence_indicators=[r'__VUE__', r'Vue\.', r'data\-v\-', r'vue\.js'],
                version_patterns=[r'Vue\.js v(\d+\.\d+\.\d+)']
            ),
            TechSignature(
                name="Angular",
                category="framework",
                patterns=[r'angular', r'ng\-', r'Angular\.', r'__ng'],
                confidence_indicators=[r'ng\-version', r'ng\-app', r'angular\.js', r'_angular']
            ),
            TechSignature(
                name="Next.js",
                category="framework",
                patterns=[r'next\.js', r'_next/', r'__NEXT_DATA__', r'next\-route'],
                confidence_indicators=[r'__NEXT_DATA__', r'_next/', r'next\-route']
            ),
            TechSignature(
                name="Nuxt.js",
                category="framework",
                patterns=[r'nuxt', r'_nuxt/', r'__NUXT__'],
                confidence_indicators=[r'__NUXT__', r'_nuxt/', r'nuxt\.js']
            ),
            # CSS Frameworks
            TechSignature(
                name="Bootstrap",
                ...
                confidence_indicators=[r'bootstrap\.css', r'bootstrap\.min\.css', r'btn\-primary'],
                version_patterns=[r'Bootstrap v(\d+\.\d+\.\d+)']
            ),
            TechSignature(
                name="Tailwind CSS",
                category="css_framework",
                patterns=[r'tailwind', r'tw\-', r'bg\-\w+\-\d+', r'text\-\w+\-\d+'],
                confidence_indicators=[r'tailwindcss', r'bg\-blue\-500', r'text\-gray\-900']
            ),
            TechSignature(
                name="Foundation",
                category="css_framework",
                patterns=[r'foundation', r'grid\-x', r'cell\-'],
                confidence_indicators=[r'foundation\.css', r'grid\-x', r'foundation\.js']
            ),
            # Analytics & Tracking
            TechSignature(
                name="Google Analytics",
                category="analytics",
                patterns=[r'google\-analytics', r'gtag\(', r'ga\(', r'GoogleAnalyticsObject', r'UA\-\d+\-\d+', r'G\-[A-Z0-9]+'],
                confidence_indicators=[r'gtag\(', r'GoogleAnalyticsObject', r'google\-analytics\.com']
            ),
            TechSignature(
                name="Google Tag Manager",
                category="analytics",
                patterns=[r'gtm\.js', r'googletagmanager', r'GTM\-[A-Z0-9]+', r'dataLayer'],
                confidence_indicators=[r'googletagmanager\.com', r'GTM\-', r'dataLayer']
            ),
            TechSignature(
                name="Facebook Pixel",
                category="analytics",
                patterns=[r'fbevents\.js', r'facebook\.net', r'connect\.facebook\.net', r'fbq\('],
                confidence_indicators=[r'fbevents\.js', r'connect\.facebook\.net', r'fbq\(']
            ),
            TechSignature(
                name="Hotjar",
                category="analytics",
                patterns=[r'hotjar', r'static\.hotjar\.com', r'hj\('],
                confidence_indicators=[r'static\.hotjar\.com', r'hj\(', r'hotjar']
            ),
            # SEO Tools
            TechSignature(
                name="Yoast SEO",
                category="seo",
                patterns=[r'yoast', r'wp\-seo', r'wpseo'],
                confidence_indicators=[r'Yoast SEO', r'wp\-seo', r'wpseo']
            ),
            TechSignature(
                name="RankMath",
                category="seo",
                patterns=[r'rank\-math', r'rankmath'],
                confidence_indicators=[r'rank\-math', r'rankmath']
            ),
            TechSignature(
                name="All in One SEO",
                category="seo",
                patterns=[r'aioseop', r'all\-in\-one\-seo'],
                confidence_indicators=[r'aioseop', r'all\-in\-one\-seo']
            ),
            # Libraries
            TechSignature(
                name="jQuery",
                ...
                confidence_indicators=[r'jquery\.js', r'jQuery', r'jquery\.min\.js'],
                version_patterns=[r'jQuery v(\d+\.\d+\.\d+)']
            ),
            TechSignature(
                name="Lodash",
                category="library",
                patterns=[r'lodash', r'_\.'],
                confidence_indicators=[r'lodash\.js', r'lodash\.min\.js']
            ),
            TechSignature(
                name="D3.js",
                category="library",
                patterns=[r'd3\.js', r'd3\.min\.js', r'd3\.'],
                confidence_indicators=[r'd3\.js', r'd3\.min\.js']
            ),
            # CDN & Security
            TechSignature(
                name="Cloudflare",
                ...
                confidence_indicators=[r'cf\-ray', r'cloudflare', r'__cfduid']
            ),
            TechSignature(
                name="Amazon CloudFront",
                category="cdn",
                patterns=[r'cloudfront', r'amazonaws\.com'],
                confidence_indicators=[r'cloudfront\.net', r'amazonaws\.com']
            ),
            # Performance Tools
            TechSignature(
                name="WP Rocket",
                category="performance",
                patterns=[r'wp\-rocket', r'wpr_'],
                confidence_indicators=[r'wp\-rocket', r'wpr_']
            ),
            TechSignature(
                name="W3 Total Cache",
                category="performance",
                patterns=[r'w3tc', r'w3\-total\-cache'],
                confidence_indicators=[r'w3tc', r'w3\-total\-cache']
            )
        ]
        ...
        for signature in self.tech_signatures:
            ...
            for indicator in signature.confidence_indicators:
                try:
                    ...
                    logger.warning(f"Regex error for indicator {indicator}: {e}")
                    continue
            ...
            if signature.version_patterns and not version:
                for version_pattern in signature.version_patterns:
                    try:
                        ...
                        logger.warning(f"Regex error for version pattern {version_pattern}: {e}")
                        continue
    ...
    def _extract_business_info(self, soup: BeautifulSoup) -> Dict[str, Any]:
        ...
        for pattern in phone_patterns:
            try:
                ...
                logger.warning(f"Regex error in phone pattern {pattern}: {e}")
                continue
        ...
        for pattern in address_patterns:
            try:
                ...
                logger.warning(f"Regex error in address pattern {pattern}: {e}")
                continue
